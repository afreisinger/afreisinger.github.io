...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Adrian Freisinger</h2>;
  const three = (
  ...
  const four = (
    <>
      <p>
        I’m a passionate engineer from Argentina with entrepreneurial spirit, experienced in
  ...
  const five = (
    <div className="button-group">
      ...
      <a
        ...
        href="/AdrianFreisingerResume.pdf"
        target="_blank"
        rel="noreferrer"
      >
        Download Resume
  ...
  const six = (
    <div className="highlighted-box">
      <span>
        ...
        <a href="https://cal.com/afreisinger/15min" target="_blank" rel="noreferrer">
          schedule a meeting.
        </a>
      </span>
    </div>
